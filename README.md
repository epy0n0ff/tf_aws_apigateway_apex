...
module "fiends" {
  ...
  resource_path           = "/friends"
  http_method             = "POST"
  lambda_function_name    = "oops"
...
module "fiends_chat" {
  source                  = "github.com/epy0n0ff/tf_aws_apigateway_apex"
  resource_path           = "/${aws_api_gateway_resource.fiends.path_part}/chat"
  lambda_function_name    = "oops"
  http_method             = "POST"
  integration_http_method = "POST"
...
# Create a sub-resource path variable 
# POST /frends/chat/{id}
module "fiends_chat_id" {
  source                  = "github.com/epy0n0ff/tf_aws_apigateway_apex"
  lambda_function_name    = "oops"
  http_method             = "POST"
  integration_http_method = "POST"
  resource_path           = "/frends/chat/*"
  resource_id             = "${aws_api_gateway_resource.fiends_chat.id}"
  rest_api_id             = "${aws_api_gateway_rest_api.test-rest-api.id}"
  apex_function_arns      = "${var.apex_function_arns}"
